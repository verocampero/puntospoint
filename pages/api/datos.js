export default function handler(req, res) {
  const data = {
    ...
    transacciones: [
      { hora: "00:00 - 04:00", total: 80.0, columnas: [20, 25, 79.975] },
      { hora: "04:00 - 08:00", total: 80.04, columnas: [40, 120, 79.92] },
      { hora: "08:00 - 12:00", total: 80.05, columnas: [10, 250, 79.8] },
      { hora: "12:00 - 16:00", total: 80.08, columnas: [30, 350, 79.73] },
    ...
    lineData: {
      ...
      dinero_total: [
        1000000, 2500000, 2200000, 5000000, 4500000, 11000000, 9500000,
      ],
